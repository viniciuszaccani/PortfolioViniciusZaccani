        ...
        <div className="container-page">
            <div className="homepage-content"> 
                <div className="homepage-title">
                    <h1>Olá, eu sou o<br />Vinicius Zaccani</h1>
                    <p>Desenvolvedor Fullstack com experiência em diversas tecnologias. Apaixonado por inovação, busco constantemente aprimorar minhas habilidades técnicas e pessoais.</p>
                    <div className="container-btn">
                        ...
                        <a href="https://www.linkedin.com/in/vinicius-zaccani-526222176/" target="_blank">
                        ...
                        <a href="https://github.com/viniciuszaccani" target="_blank">
